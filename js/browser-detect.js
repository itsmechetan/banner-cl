(function (global, factory) {
  ...
  var Detector = /** @class */ (function () {
    ...
    Detector.prototype.checkMobile = function () {
      ...
      var mobile =
        mobileRegExp.test(this.userAgent) ||
        mobilePrefixRegExp.test(agentPrefix);
    ...
    Detector.prototype.getOsPattern = function (definition) {
      ...
      return (
        (typeof definition === "string" ? definition : undefined) ||
